      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            <div className="md:col-span-1 text-center animate-fadeInUp">
            ...
            <div className="md:col-span-2 bg-gray-800/50 backdrop-blur-sm border-2 border-yellow-500/50 rounded-2xl p-8">
